...
def create_file_report_agent_with_hooks(
    ...
    if use_realtime_hooks:
        message_hook = MessageHookProvider(
            ...
            s3_bucket=s3_bucket,
            agent_name="FileReportAgentWithHooks",
        )
...
def main():
    ...
    try:
        ...
        agent = create_file_report_agent_with_hooks(
            storage_type="local",
        ...
        print("Check the directory for files named: <timestamp>-FileReportAgentWithHooks-msg<number>-<role>.json")
